# Spins up a local Umbraco 17 site that hosts the Lait Tracking package, then runs it.
...
$pkgProj = Join-Path $repo 'src\Lait.Umbraco.Analytics.Plausible\Lait.Umbraco.Analytics.Plausible.csproj'
...
Write-Host "==> Referencing the Lait Tracking package project" -ForegroundColor Cyan
...
Write-Host "Content section -> 'Tracking' tab. Open any document -> 'Info' tab for the per-page block." -ForegroundColor Green
Write-Host ""
