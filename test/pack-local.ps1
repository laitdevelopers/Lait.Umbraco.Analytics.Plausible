...
$proj = Join-Path $repo 'src\Lait.Umbraco.Analytics.Plausible\Lait.Umbraco.Analytics.Plausible.csproj'
...
Write-Host "  dotnet add package Lait.Umbraco.Analytics.Plausible" -ForegroundColor Green
Write-Host ""
